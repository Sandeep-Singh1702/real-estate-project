...
selected_loaction = st.selectbox('Location',sorted(location_df.columns.to_list())) 
radius = st.number_input("Enter Radius ")

if st.button("Search"):
    result_ser = location_df[location_df[selected_loaction]< radius*1000][selected_loaction].sort_values()
